		...
		<div class="container mx-auto py-6 px-4 max-w-2xl">
			...
			<div class="mb-6">
				...
				<p class="text-sm text-muted-foreground mt-1">
					{{ isEditing ? 'Update your offline working time details' : 'Log your offline working hours' }}
				</p>
			</div>
			...
			<Card class="shadow-sm border-slate-200">
				<CardHeader class="pb-4">
					...
					<CardDescription class="text-xs">
						Fill in the details of your offline work time. All fields marked with * are required.
					</CardDescription>
				</CardHeader>
				<CardContent>
					<form @submit.prevent="submit" class="space-y-6">
						...
						<div class="flex items-center gap-3 pt-4">
							<Button type="submit" :disabled="form.processing" class="min-w-[120px]">
								...
								{{ form.processing ? 'Saving...' : isEditing ? 'Update Entry' : 'Save Entry' }}
							</Button>
